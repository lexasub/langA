...
public class langosIRParser extends Parser {
	...
	public static final int
		...
		PAIRMAPo_=15, PAIRMAPoo=16, POP=17, PUSH=18, MOV=19, EQCALL_THEN_JMP=20, 
		NEQCALL_THEN_JMP_EXTENDED=21, EQ=22, JMP=23, BREAK=24, CONTINUE=25, FUNC=26, 
		CALL=27, RET=28, INTOSCOPE=29, OUTOFSCOPE=30, ENTERSCOPE=31, EXITSCOPE=32, 
		FUNCTION_ARGUMENT=33, WS=34, TAB=35, UNTAB=36, ID=37, FUNCID=38;
	public static final int
		RULE_id = 0, RULE_intoscope = 1, RULE_class = 2, RULE_endclass = 3, RULE_import_ = 4, 
		RULE_map = 5, RULE_mapo = 6, RULE_pairmap = 7, RULE_pairmap_o = 8, RULE_pairmapo_ = 9, 
		RULE_pairmapoo = 10, RULE_pop = 11, RULE_push = 12, RULE_jmp = 13, RULE_call = 14, 
		RULE_eq = 15, RULE_eQCALL_THEN_JMP = 16, RULE_nEQCALL_THEN_JMP_EXTENDED = 17, 
		RULE_func_lbl = 18, RULE_lbl = 19, RULE_member_declare = 20, RULE_class_full = 21, 
		RULE_jmps = 22, RULE_flow_control = 23, RULE_scope_control = 24, RULE_stack_cmds = 25, 
		RULE_map_control = 26, RULE_function_argument = 27, RULE_func = 28, RULE_get_element_ptr = 29, 
		RULE_mov = 30, RULE_program = 31, RULE_entry_point = 32;
	private static String[] makeRuleNames() {
		return new String[] {
			"id", "intoscope", "class", "endclass", "import_", "map", "mapo", "pairmap", 
			"pairmap_o", "pairmapo_", "pairmapoo", "pop", "push", "jmp", "call", 
			"eq", "eQCALL_THEN_JMP", "nEQCALL_THEN_JMP_EXTENDED", "func_lbl", "lbl", 
			"member_declare", "class_full", "jmps", "flow_control", "scope_control", 
			"stack_cmds", "map_control", "function_argument", "func", "get_element_ptr", 
			"mov", "program", "entry_point"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'PAIRMAPo_'", "'PAIRMAPoo'", "'POP'", "'PUSH'", "'MOV'", "'EQCALL_THEN_JMP'", 
			"'NEQCALL_THEN_JMP_EXTENDED'", "'EQ'", "'JMP'", "'BREAK'", "'CONTINUE'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PAIRMAPo_", "PAIRMAPoo", "POP", "PUSH", "MOV", "EQCALL_THEN_JMP", "NEQCALL_THEN_JMP_EXTENDED", 
			"EQ", "JMP", "BREAK", "CONTINUE", "FUNC", "CALL", "RET", "INTOSCOPE", 
			"OUTOFSCOPE", "ENTERSCOPE", "EXITSCOPE", "FUNCTION_ARGUMENT", "WS", "TAB", 
			"UNTAB", "ID", "FUNCID"
		};
	}
	...
	public final IntoscopeContext intoscope() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_intoscope);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(68);
	...
	public final EndclassContext endclass() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_endclass);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(74);
	...
	public final MapoContext mapo() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_mapo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(91);
	...
	public final Pairmap_oContext pairmap_o() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_pairmap_o);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(103);
	...
	public final Pairmapo_Context pairmapo_() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_pairmapo_);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(110);
	...
	public final PairmapooContext pairmapoo() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_pairmapoo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(117);
	...
	public final JmpContext jmp() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_jmp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(130);
	...
	public final EQCALL_THEN_JMPContext eQCALL_THEN_JMP() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_eQCALL_THEN_JMP);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(154);
	...
	public final NEQCALL_THEN_JMP_EXTENDEDContext nEQCALL_THEN_JMP_EXTENDED() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_nEQCALL_THEN_JMP_EXTENDED);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(161);
	...
	public final Stack_cmdsContext stack_cmds() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_stack_cmds);
		try {
			setState(228);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Map_controlContext map_control() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_map_control);
		try {
			setState(236);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Get_element_ptrContext get_element_ptr() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_get_element_ptr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257);
	...
	public final Entry_pointContext entry_point() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_entry_point);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CLASS) | (1L << IMPORT) | (1L << GET_ELEMENT_PTR) | (1L << MAP) | (1L << MAPo) | (1L << PAIRMAP) | (1L << PAIRMAP_o) | (1L << PAIRMAPo_) | (1L << PAIRMAPoo) | (1L << POP) | (1L << PUSH) | (1L << MOV) | (1L << EQCALL_THEN_JMP) | (1L << NEQCALL_THEN_JMP_EXTENDED) | (1L << EQ) | (1L << JMP) | (1L << BREAK) | (1L << CONTINUE) | (1L << CALL) | (1L << RET) | (1L << INTOSCOPE) | (1L << OUTOFSCOPE) | (1L << ENTERSCOPE) | (1L << ID))) != 0)) {
				{
				{
				setState(281);
				program();
