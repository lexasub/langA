...
public class langosIRLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "LOWBAR", "ARROW", "COLON", "SLASH", "COMA", "LPAREN", "RPAREN", 
			"SHARP", "CLASS", "ENDCLASS", "MEMBER", "IMPORT", "GET_ELEMENT_PTR", 
			"MAP", "MAPo", "PAIRMAP", "PAIRMAP_o", "PAIRMAPo_", "PAIRMAPoo", "POP", 
			"PUSH", "MOV", "PHI", "EQCALL_THEN_JMP", "NEQCALL_THEN_JMP_EXTENDED", 
			"EQ", "JMP", "BREAK", "CONTINUE", "FUNC", "CALL", "RET", "ENTERSCOPE", 
