...
public class langosWithoutSyntaxParser extends Parser {
	...
	public final Braced_elementContext braced_element() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << BREAK) | (1L << CONTINUE) | (1L << IF) | (1L << MAP) | (1L << PAIRMAP) | (1L << RETURN) | (1L << WHILE) | (1L << RPAREN) | (1L << ID))) != 0)) {
				{
				{
				setState(119);
				element();
	...
	public final Expr_listContext expr_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << BREAK) | (1L << CONTINUE) | (1L << IF) | (1L << MAP) | (1L << PAIRMAP) | (1L << RETURN) | (1L << WHILE) | (1L << RPAREN) | (1L << ID))) != 0)) {
				{
				setState(127);
				expr();
				}
